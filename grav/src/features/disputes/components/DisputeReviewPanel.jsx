...
import { AlertCircle, ArrowRight, ShieldAlert, FileText, Upload, Camera, FileCheck2, Scale, Eye } from 'lucide-react';

export default function DisputeReviewPanel({ selectedDispute, closeReview }) {
