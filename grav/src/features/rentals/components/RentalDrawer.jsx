...
import { X, ChevronLeft, Calendar, Clock, Shield, CheckCircle, FileText, Image as ImageIcon } from 'lucide-react';

export default function RentalDrawer({ showDrawer, setShowDrawer, selectedRental }) {
  return (
    <>
      {/* Drawer Overlay */}
      {showDrawer && (
